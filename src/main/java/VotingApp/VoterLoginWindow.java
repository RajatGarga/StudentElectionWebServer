...
public class VoterLoginWindow {
	...
	VoterLoginWindow() {
		...
		usernameTextBox.setBounds(233, 19, 135, 20);
		...
		pwdTextBox = new JTextField();
		pwdTextBox.setBounds(233, 60, 135, 20);
		f.getContentPane().add(pwdTextBox);
		pwdTextBox.setColumns(10);

		JButton btnLogin = new JButton("Login");
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				id = usernameTextBox.getText();
				pwd = pwdTextBox.getText();
				try {
