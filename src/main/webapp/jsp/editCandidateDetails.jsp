		...
		<form autocomplete="off" class="form-style-Bitter" action="../candidateProfile/Save" method="post">
			...
			<div class="section"><span style="position:relative">1</span>Name</div>
    			...
    			<div class="inner-wrap">
    				...
    				<select style="border-radius:20px;" id="batch" name="batch" value="${candidate.batch}" required>
    				...
    				<select style="border-radius:20px;" id="branch" value="${candidate.branch}" name="branch" required>
