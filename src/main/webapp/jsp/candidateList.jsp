  ...
  <main class="content">
  	<div class="container-fluid" style="padding:10px;">
  		...
  		<div class="row" style="color:white;background-color:rgb(88, 78, 74);border:solid 3px #675f6b;margin:20px;padding:20px;border-radius:50px;">
  			...
  			<form>
  			<div class="col-md-2" style="text-align:center;"><label class="radio-inline"><input type="radio" name="optradio" style="visibility:hidden;" class="all" onclick="handleReq('all')"><strong>all</strong></label></div>
